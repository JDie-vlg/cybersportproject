...
<div class="main-container">
    <div class="main-block">
        <div class="header">
            <div class="main-logo">
                <a href="">
                    <img src="" alt="kartinka 1">
                </a>
            </div>
            <div class="decoration-image">
                <div class="image-text">
                    <img src="" alt="kartinka 2">
                </div>
            </div>
        </div>
        <div class="navigation-bar">
            <ul class="nav-bar">
                <li><a class="home-list" href="#">HOME</a></li>
                <li><a class="news-list" href="#">NEWS</a></li>
                <li><a class="project-list" href="#">OUR PROJECTS</a></li>
                <li><a class="tournaments-list" href="#">TOURNAMENTS</a></li>
                <li><a class="info-list" href="#">INFO</a></li>
            </ul>
        </div>
        <div class="settings-bar">
            <div class="search">
                <form class="search-form">
                    <input class="search-text" placeholder="Поиск...">
                    <button class="fa fa-search" type="submit"><span></span></button>
                </form>
        ...
        <div class="content-block">
            <div class="carousel-tournaments-block">
                <div class="news-carousel-block">
                    карусель новостей
                </div>
                <div class="tournaments-matches-block">
                    <div>игры</div>
                    <div>матчи</div>
                </div>
            </div>
            <div class="streams-block">
                <div class="streams-block-title">
                    <p>СТРИМЫ</p>
                </div>
